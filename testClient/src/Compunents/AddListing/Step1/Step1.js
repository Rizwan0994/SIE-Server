...
export default function Step1() {
  ...
  const blueCard = {
    ...
    width: isExtended ? "500px" : isTablet ? "340px" : isMobile ? "" : "",
    marginTop: isMobile ? "" : isXL ? "" : "-5%",
  };
  ...
  return (
    <div
      ...
      style={{ padding: "0px", height: "vh", paddingTop: isMobile ? "%" : "" }}
    >
      ...
      {!isMobile && (
        <div
          ...
          style={{ width: isMobile ? "" : isTablet ? "" : "99%" }}
        >
      ...
      <div
        className={`container${isTablet ? "-fluid" : ""}`}
        style={{
      ...
      >
        <div className="row justify-content-sm-around justify-content-lg-center align-items-center">
          <div className="col-12 col-sm-6" style={blueCard}>
            <div
              ...
              style={{
                ...
                padding: isMobile ? "3%" : isTablet ? "4%" : "9%",
          ...
          <div
            className="col-12 col-sm-6 d-lg-grid justify-content-xl-end justify-content-center"
            style={{ padding: isMobile ? "4%" : "" }}
          >
            {cardsData.map((card, index) => (
              <React.Fragment key={index}>
                ...
                {index < 2 && (
                  <hr
                    style={{
                      marginLeft: isMobile ? "" : isXL ? "" : "%",
                      width: isMobile ? "" : isXL ? "342px" : "%",
                    }}
                  />
                )}
              </React.Fragment>
        ...
        <div className="row" style={{ width: "99%" }}>
          <div className="col-12" style={{ marginTop: "%" }}>
            <img
              ...
              alt=""
              style={{
                height: isXL ? "291" : "257px",
                width: isTablet ? " " : "1010px",
                marginTop: isXL ? "-5" : "",
              }}
            />
          </div>
