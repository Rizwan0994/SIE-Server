...
console.log(fromdate + " sadasas  " + todate);
  ...
  const handleCard = (boat) => {
    if (fromdate !== undefined) {
      const searchParams = new URLSearchParams();
      searchParams.append("boat", JSON.stringify(boat));
      searchParams.append("fromdate", JSON.stringify(fromdate));
      searchParams.append("todate", JSON.stringify(todate));
      // window.location.href = `/detail?${searchParams.toString()}`;
